...
class TestTelegramBot(unittest.TestCase):
    ...
    def test_start_command(self):
        ...
        state = Mock()
        with patch("telegram_bot.add_user_to_db_type_user") as mock_add_user:
            start(message, state)
    ...
    def test_process_user_type_employer(self):
        ...
        state = Mock()
        with patch("telegram_bot.add_user_to_db_type_employer") as mock_add_employer:
            process_user_type(callback_query, state)
    ...
    def test_process_age(self):
        ...
        message.text = "25"
        state = Mock()
        with patch("telegram_bot.update_user_age") as mock_update_age:
    ...
    def test_process_location(self):
        ...
        state = Mock()
        with patch("telegram_bot.update_user_location") as mock_update_location:
    ...
    def test_process_nickname(self):
        ...
        message.text = "John"
        state = Mock()
        with patch("telegram_bot.update_user_name") as mock_update_name:
    ...
    def test_process_description(self):
        ...
        state = Mock()
        with patch("telegram_bot.update_user_description") as mock_update_description:

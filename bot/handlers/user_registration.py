...
async def register_job_seeker(user_tgid, user_tgname, user_fullname, user_language):
    await add_user_to_db_type_user(user_tgid, user_tgname, user_fullname, user_language, user_type="USER")
